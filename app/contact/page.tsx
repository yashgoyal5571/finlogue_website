...
export default function ContactPage() {
  ...
  useEffect(() => {
    fetch("/api/admin/content?section=contact", { cache: "no-store" })
      .then((res) => (res.ok ? res.json() : null))
      .then((data) => {
        if (!data) return;
        const payload = data.data || data;
        if (payload && payload.office) {
        ...
        <div className="container">
          <div className="grid-2" style={{ gap: "44px", alignItems: "start" }}>
            ...
            <ScrollReveal direction="up" delay={50}>
              <div
                className="intake-slip-card gold-glow-hover"
                style={{
                  ...
                  <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
                    ...
                    >
                      ...
                      >
                        ...
                        <span className="btn-arrow" style={{ fontSize: "12px" }}>→</span>
                      </button>
                    </div>
                  </form>
                )}
              ...
              <ScrollReveal direction="up" delay={120}>
                ...
                >
                  ...
                  <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
                    {contactData.coordinators.map((c, cIdx) => (
                      <div
                        key={c.name}
                        className="gold-glow-hover shimmer-sweep"
                        style={{
                          padding: "22px 24px",
